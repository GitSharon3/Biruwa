...
<body>
   ...
   <!-- Comment Section -->
<div style="text-align: center; padding: 20px; background-color: #f0faf0; border-radius: 10px; margin: 20px auto; max-width: 800px;">
   ...
   <div style="display: none; margin-top: 20px; background-color: white; padding: 20px; border-radius: 10px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);" class="replyDiv">
